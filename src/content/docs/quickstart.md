...
<aside class="notice">
The <a href="https://github.com/WebODM/WebODM/tree/master/docs/examples/process_images.py" target="_blank">source code</a> for this example is available on GitHub</a>.
</aside>
